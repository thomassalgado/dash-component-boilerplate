...
1. Fork this repo
2. Find-and-replace:
    1. `highcharts_dash_component` with your component library name.
    2. `highcharts-dash-component` with your component library name.
    3. `Rafael Thomas Pontes Salgado` with your name and `thomassalgado@gmail.com` with your email address
    4. `MIT` with your license (e.g. `MIT`)
    5. Rename the folder `highcharts_dash_component/` with your component library name
...
7. Create a production build and publish:
    ...
    ```
    pip install highcharts_dash_component-0.0.1.tar.gz
    ```
...
# More details
- Include CSS files in your distribution folder (`highcharts_dash_component`) and reference them in `MANIFEST.in`
